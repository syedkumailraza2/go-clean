                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 66.0),
                          child: Text(
                            translated[0].isEmpty ? txt[0] : translated[0], //'Sign Up'
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: translated[3].isEmpty ? txt[3] : translated[3], //'User name'
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                              ...
                              hintText: translated[3].isEmpty ? txt[3] : translated[3], //'User name'
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: translated[4].isEmpty ? txt[4] : translated[4],//'Email address',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                              ...
                              hintText: translated[4].isEmpty ? txt[4] : translated[4],//'Email address',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                        ...
                        Padding(
                          ...
                          child: custom_widgets.CustomLabelCountryCodeWidget(
                            ...
                            labeltxt: translated[5].isEmpty ? txt[5] : translated[5], //'Phone number',
                            height: 56.0,
                          ),
                        ),
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: translated[6].isEmpty ? txt[6] : translated[6],//'Password',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                              ...
                              hintText: translated[6].isEmpty ? txt[6] : translated[6],//'Password',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'SF Pro Display',
                ...
                child: InkWell(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: translated[1].isEmpty ? txt[8] : translated[8], //'Already  have an account ? ',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: 'SF Pro Display',
                        ...
                        TextSpan(
                          text: translated[9].isEmpty ? txt[9] : translated[9], //'Sign in',
                          style: TextStyle(
                            color: FlutterFlowTheme.of(context).primary,
                            fontWeight: FontWeight.bold,
                            fontSize: 16.0,
