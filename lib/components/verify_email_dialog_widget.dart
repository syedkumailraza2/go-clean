...
import 'verify_email_dialog_model.dart';
export 'verify_email_dialog_model.dart';

class VerifyEmailDialogWidget extends StatefulWidget {
  const VerifyEmailDialogWidget({
    super.key,
    required this.email,
  });
  ...
  @override
  State<VerifyEmailDialogWidget> createState() =>
      _VerifyEmailDialogWidgetState();
}

class _VerifyEmailDialogWidgetState extends State<VerifyEmailDialogWidget> {
  late VerifyEmailDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyEmailDialogModel());
  }
